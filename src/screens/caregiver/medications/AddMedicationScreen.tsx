...
import { medicationsCollection, serverTimestamp } from '../../../services/firebase';
import Input from '../../../components/common/Input';
import Button from '../../../components/common/Button';
import { FamilyColors } from '../../../design/colors';

type AddMedicationScreenProps = {
  navigation: StackNavigationProp<CaregiverStackParamList, 'AddMedication'>;
};
...
const AddMedicationScreen: React.FC<AddMedicationScreenProps> = ({ navigation }) => {
  ...
  const [times, setTimes] = useState<Date[]>([new Date(0, 0, 0, 8, 0)]);
  ...
  const handleSave = async () => {
    ...
    try {
      await medicationsCollection().add({
